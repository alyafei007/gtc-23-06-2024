...
class res_users(models.Model):
    ...
    sh_enable_full_screen_mode = fields.Boolean('Enable Full Screen Mode')
    sh_enable_calculator_mode = fields.Boolean('Enable Calculator Mode')
    sh_enable_gloabl_search_mode = fields.Boolean('Enable Global Search Mode',default=True)
    sh_enable_quick_menu_mode  = fields.Boolean("Enable Quick Menu Mode")
